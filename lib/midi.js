      ...
      switch (mm.messageType) {
        case 'noteon':
          ...
          if (opts.recording === true) {
            recordingNoteOnEvents[mm.key] = mm
          }
          break
        case 'noteoff':
          if (opts.recording === true && recordingNoteOnEvents[mm.key]) {
            opts.recordBuffer.push({
              ...
              durationTicks: mm._event.timeStamp - recordingNoteOnEvents[mm.key]._event.timeStamp,
              ticks: recordingNoteOnEvents[mm.key]._event.timeStamp,
